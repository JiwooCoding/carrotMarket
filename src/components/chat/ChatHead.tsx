...
import { IoChevronBackCircleOutline, IoChevronBackCircleSharp } from 'react-icons/io5';
...
const ChatHead = ({setLayout, receiverName, receiverImage, lastMessageTime}:ChatHeadProps) => {
  return (
